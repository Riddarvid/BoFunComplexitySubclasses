...
-- Naive
genAlg :: (BoFun fun i, Algor a i, Ord a) => fun -> S.Set a
...
genAlgThinMemo :: (BoFun fun i, Memoizable fun, Thin a, Algor a i) => fun -> S.Set a
...
genAlgStep ::  (BoFun fun i, Algor a i, Ord a) =>
               (fun -> S.Set a) ->
               (fun -> S.Set a)
genAlgStep _ fun
