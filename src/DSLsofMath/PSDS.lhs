...
Note that degree will return |-1| as the "degree" of the zero polynomial.
\begin{code}
...
comparePoly p1 p2 = let P p1N = normalPoly p1
                        P p2N = normalPoly p2
--                    in compare p2N p1N -- can be used to provoke the computation
                    in compare p1N p2N
-- comparePoly (P xs) (P ys) = compare xs ys
