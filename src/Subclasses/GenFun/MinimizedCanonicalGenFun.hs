...
import           Subclasses.GenFun.MinimizedGenFun (minimizeGenFun)
...
mkNCGF = NCGF . toCanonicForm . minimizeGenFun
...
instance BoFun MinimizedCanonicalGenFun Int where
  ...
  setBit v = NCGF . toCanonicForm . minimizeGenFun . unlift (setBit v)
